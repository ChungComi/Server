...
//    private SchoolDTO school;
    ...
    public ResponseMemberDTO(Member member){
        ...
        /** 반환할 선호 기업 DTO 설정 **/
//        List<MemberCompany> memberCompanyDTOs = member.getMemberCompany()
//                .stream().map(memberCompany -> new MemberCompanyDTO(memberTechStack.getPreference(),memberTechStack.getTechStack().getName()))
//                .toList();
